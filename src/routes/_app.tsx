...
import { BarChart3, Bot, Upload, Users, LayoutGrid, Settings, ChartBar, Activity, Trophy, ClipboardCheck, DollarSign, TrendingUp, CalendarDays } from "lucide-react";
        ...
        <div className="mx-auto flex max-w-7xl items-center justify-between gap-4 px-6 py-4">
          ...
          <div className="flex items-center gap-2">
            <nav className="flex items-center gap-1">
              ...
              <NavLink to="/fechamento-semanal" icon={<CalendarDays className="h-4 w-4" />}>Semanas</NavLink>
              <NavLink to="/produtividade" icon={<Activity className="h-4 w-4" />}>Produtividade</NavLink>
              <NavLink to="/resultados" icon={<TrendingUp className="h-4 w-4" />}>Resultados</NavLink>
              ...
              <NavLink to="/comissionamento" icon={<DollarSign className="h-4 w-4" />} iconOnly />
